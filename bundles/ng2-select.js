...
System.registerDynamic('ng2-select/components/select/select', ['@angular/core', '@angular/platform-browser', './select-item', './select-pipes', './common'], true, function ($__require, exports, module) {
  ...
  __decorate([core_1.Input(), __metadata('design:type', Boolean)], SelectComponent.prototype, 'allowClear', void 0);
  __decorate([core_1.Input(), __metadata('design:type', Boolean)], SelectComponent.prototype, 'allowSearch', void 0);
  ...
  __decorate([core_1.Output(), __metadata('design:type', core_1.EventEmitter)], SelectComponent.prototype, 'typed', void 0);
  ...
  }), __metadata('design:paramtypes', [core_1.ElementRef, platform_browser_1.DomSanitizer])], SelectComponent);
...
System.registerDynamic('ng2-select/components/select/select-pipes', ['@angular/core', './common'], true, function ($__require, exports, module) {
  ...
  HighlightPipe = __decorate([core_1.Pipe({name: 'highlight'})], HighlightPipe);
...
System.registerDynamic('ng2-select/components/select/off-click', ['@angular/core'], true, function ($__require, exports, module) {
  ...
  OffClickDirective = __decorate([core_1.Directive({selector: '[offClick]'})], OffClickDirective);

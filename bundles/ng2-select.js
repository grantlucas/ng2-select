...
System.registerDynamic('ng2-select/components/select/select', ['@angular/core', '@angular/platform-browser', './select-item', './select-pipes', './common'], true, function ($__require, exports, module) {
  ...
  var SelectComponent = function () {
    ...
    SelectComponent.ctorParameters = function () {
      return [{type: core_1.ElementRef}, {type: platform_browser_1.DomSanitizer}];
    };
...
System.registerDynamic('ng2-select/components/select/off-click', ['@angular/core'], true, function ($__require, exports, module) {
  ...
  var OffClickDirective = function () {
    ...
    OffClickDirective.decorators = [{type: core_1.Directive, args: [{selector: '[offClick]'}]}];

        /** @nocollapse */
    OffClickDirective.ctorParameters = function () {
      return [];
    };
    OffClickDirective.propDecorators = {'offClickHandler': [{type: core_1.Input, args: ['offClick']}]};
